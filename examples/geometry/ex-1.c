...
*****************************************************************************/
	...
	if (lint(p1_rct, p2_rct, p3_rct, p4_rct)) {
		...
		fprintf(stdout,
			"(%+.1lf,%+.1lf) to (%+.1lf,%+.1lf) and (%+.1lf,%+.1lf) "
			"to (%+.1lf,%+.1lf) Y", p1_rct.x, p1_rct.y, p2_rct.x,
			p2_rct.y, p3_rct.x, p3_rct.y, p4_rct.x, p4_rct.y);
		...
		fprintf(stdout,
			"(%+.1lf,%+.1lf) to (%+.1lf,%+.1lf) and (%+.1lf,%+.1lf) "
			"to (%+.1lf,%+.1lf) N", p1_rct.x, p1_rct.y, p2_rct.x,
			p2_rct.y, p3_rct.x, p3_rct.y, p4_rct.x, p4_rct.y);
...
*****************************************************************************/
	...
	for (i = 0; i < CVXPCT; i++) {
		...
		fprintf(stdout, "P[%03d]=(%+.1lf,%+.1lf,%+.1lf)\n", i,
			CvxTestP[i].x, CvxTestP[i].y, CvxTestP[i].z);
