...
*****************************************************************************/
	...
	fprintf(stdout,
		"Inserting an invalid edge from %s to %s...Value=%d (-1=OK)\n",
		data1, data2, retval);
	...
	retval = graph_ins_edge(&graph, data1, data2);
	fprintf(stdout,
		"Inserting an existing edge from %s to %s...Value=%d (1=OK)\n",
		data1, data2, retval);
	...
	fprintf(stdout,
		"Removing an invalid edge from %s to %s...Value=%d (-1=OK)\n",
		data1, data2, retval);
	...
	fprintf(stdout,
		"Testing graph_is_adjacent (%s, %s)...Value=%d (1=OK)\n", data1,
		data2, retval);
	...
	retval = graph_is_adjacent(&graph, data1, data2);
	fprintf(stdout,
		"Testing graph_is_adjacent (%s, %s)...Value=%d (0=OK)\n", data1,
		data2, retval);
