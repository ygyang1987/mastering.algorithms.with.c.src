...
*****************************************************************************/
	...
	for (element = list_head(&graph->adjlists); element != NULL; element =
		...
		if (graph->
		    match(data, ((AdjList *) list_data(element))->vertex))
			return 1;
...
*****************************************************************************/
	...
	if ((retval =
	     list_ins_next(&graph->adjlists, list_tail(&graph->adjlists),
			   adjlist)) != 0) {
...
*****************************************************************************/
	...
	for (element = list_head(&graph->adjlists); element != NULL; element =
		...
		if (graph->
		    match(data2, ((AdjList *) list_data(element))->vertex))
			break;
	...
	for (element = list_head(&graph->adjlists); element != NULL; element =
		...
		if (graph->
		    match(data1, ((AdjList *) list_data(element))->vertex))
			break;
...
*****************************************************************************/
   ...
   **************************************************************************/
		...
		if (set_is_member
		    (&((AdjList *) list_data(element))->adjacent, *data))
			return -1;
