	...
	*tree = NULL;
	...
	for (c = 0; c <= UCHAR_MAX; c++) {
      ...
      ***********************************************************************/
			...
			if ((data =
			     (HuffNode *) malloc(sizeof(HuffNode))) == NULL) {
			...
			size, HuffCode * table)
{
	...
	if (!bitree_is_eob(node)) {
      ...
      ***********************************************************************/
			...
			build_table(bitree_left(node), code << 1, size + 1,
				    table);
      ...
      ***********************************************************************/
			...
			build_table(bitree_right(node), (code << 1) | 0x0001,
				    size + 1, table);
      ...
      ***********************************************************************/
			...
			table[((HuffNode *) bitree_data(node))->symbol].used =
			    1;
			table[((HuffNode *) bitree_data(node))->symbol].code =
			    code;
			table[((HuffNode *) bitree_data(node))->symbol].size =
			    size;
